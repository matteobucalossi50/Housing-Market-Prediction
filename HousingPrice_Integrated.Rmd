...
Everything looks better now; we then added the two factor variables into the dataset to see their effects.
...
All levels of condition are unsignificant, so we drop the condition variable. And high grade has a significant effect on price.
