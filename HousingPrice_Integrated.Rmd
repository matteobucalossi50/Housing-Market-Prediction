...
```{r, echo=FALSE}
kc_house_data <- read.csv("~/Downloads/kc_house_data.csv")
str(kc_house_data)
...
x2test2
```
Since both p-values are lower 0.05, we need to reject the null hypothesis. Thus, the number of bedrooms and the number of bathrooms are not independent from the grade of house. They are corrlated. Generally, the price increases when the number of bedrooms and bathrooms become greater.
