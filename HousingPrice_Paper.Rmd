...
As mentioned previously, our dataset houses 21,613 observations across 21 variables. These variables include the following (variable descriptions come from the following link: https://bit.ly/2MsyRFl; astericks next to variable name indicates usage in our analysis):
