...
##PCA part
scale=T normalize the variables becuase they have different scales.As the 10 variable have different scales, it is necessary to scale them before analysis. Performing PCA on un-normalized variables will lead to insanely large loadings for variables with high variance.
